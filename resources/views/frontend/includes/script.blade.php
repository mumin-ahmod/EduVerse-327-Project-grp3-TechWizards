    ...
    <!-- Page level plugins -->
    <script src="{{ asset('ui/frontend') }}/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('ui/frontend') }}/js/demo/chart-area-demo.js"></script>
    <script src="{{ asset('ui/frontend') }}/js/demo/chart-pie-demo.js"></script>
